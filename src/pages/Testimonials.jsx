            ...
            <main className="min-h-screen bg-brand-bg pb-24">
                ...
                <section className="py-20 border-b border-brand-text/5">
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl font-bold text-center mb-12">Video Transformations</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[1, 2, 3].map((v) => (
                                <div key={v} className="rounded-2xl overflow-hidden glass-panel border border-brand-text/10 group cursor-pointer relative aspect-video bg-[#E2E8F0]">
                ...
                <section className="py-20">
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl font-bold text-center mb-12">Written Reviews</h2>
